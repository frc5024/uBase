 ...
 */
public class BufferedSolenoid extends Solenoid implements IFlushable, Loggable {
    ...
    public BufferedSolenoid(int moduleNumber, int channel) {
        super(moduleNumber, channel);

        // Determine component name
        name = String.format("BufferedSolenoid (%d:%d)", moduleNumber, channel);
